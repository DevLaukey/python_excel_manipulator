...
def calculate_revenues(df):
    ...
    revenue_formulas = {
        'Day-ahead revenues (€)': ['B5 + B5', 'B6 + B6'],
        # 'primary up band revenues (€)': ['column5 + column6', 'column7 + column8'],
        # 'primary down band revenues (€)': ['column9 + column10', 'column11 + column12'],
        # # Add formulas for other revenue types
    }
