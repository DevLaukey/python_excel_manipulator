...
def calculate_revenues(df):
    ...
    revenue_formulas = {
        'Day-ahead revenues (€)': ['Day-ahead revenues (€)_1 + Day-ahead revenues (€)_2',
                                   'Day-ahead revenues (€)_3 + Day-ahead revenues (€)_4'],
        'primary up band revenues (€)': ['primary up band revenues (€)_1 + primary up band revenues (€)_2',
                                         'primary up band revenues (€)_3 + primary up band revenues (€)_4'],
        'primary down band revenues (€)': ['primary down band revenues (€)_1 + primary down band revenues (€)_2',
                                           'primary down band revenues (€)_3 + primary down band revenues (€)_4'],
